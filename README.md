...
**PlutoLauncher** is a tool to launch [Pluto.jl](https://github.com/fonsp/Pluto.jl) in a predefined environment using your browser's app mode. It provides a seamless and focused experience for working with Pluto notebooks.
...
PlutoLauncher requires a **Chromium-based browser** to run Pluto in app mode. The following browsers are officially supported:
